...
# This is the lattice version
	...
	if ((freckles) & (method == "points")) message("Points & freckles don't make sense together, only plotting points")
	...
	# Some items usuable by both options below
	...
	if (!TwoFac) { # Handle everything for one fac here
		...
		# Now the high level plot calls which may use the panel functions above
